...
atan2_test (void)
{
  ...
  check_float ("atan2 (0.75, -1.0) == 2.49809154479650885165983415456218025",  FUNC(atan2) (0.75L, -1.0L), 2.49809154479650885165983415456218025L, DELTA78, 0, 0);
  check_float ("atan2 (-0.75, -1.0) == -2.49809154479650885165983415456218025",  FUNC(atan2) (-0.75L, -1.0L), -2.49809154479650885165983415456218025L, DELTA79, 0, 0);
  ...
  check_float ("atan2 (1.390625, 0.9296875) == 0.981498387184244311516296577615519772",  FUNC(atan2) (1.390625L, 0.9296875L), 0.981498387184244311516296577615519772L, DELTA81, 0, 0);

  check_float ("atan2 (-0.00756827042671106339, -.001792735857538728036) == -1.80338464113663849327153994379639112",  FUNC(atan2) (-0.00756827042671106339L, -.001792735857538728036L), -1.80338464113663849327153994379639112L, DELTA82, 0, 0);
...
catan_test (void)
{
  ...
  check_complex ("catan (0.75 + 1.25 i) == 1.10714871779409050301706546017853704 + 0.549306144334054845697622618461262852 i",  FUNC(catan) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (1.10714871779409050301706546017853704L, 0.549306144334054845697622618461262852L), DELTA304, 0, 0);
...
cbrt_test (void)
{
  ...
  check_float ("cbrt (-0.001) == -0.1",  FUNC(cbrt) (-0.001L), -0.1L, DELTA350, 0, 0);
  check_float ("cbrt (8) == 2",  FUNC(cbrt) (8), 2, 0, 0, 0);
  check_float ("cbrt (-27.0) == -3.0",  FUNC(cbrt) (-27.0), -3.0, DELTA352, 0, 0);
  check_float ("cbrt (0.9921875) == 0.997389022060725270579075195353955217",  FUNC(cbrt) (0.9921875L), 0.997389022060725270579075195353955217L, DELTA353, 0, 0);
...
clog_test (void)
{
  ...
  check_complex ("clog (-2 - 3 i) == 1.2824746787307683680267437207826593 - 2.1587989303424641704769327722648368 i",  FUNC(clog) (BUILD_COMPLEX (-2, -3)), BUILD_COMPLEX (1.2824746787307683680267437207826593L, -2.1587989303424641704769327722648368L), DELTA578, 0, 0);
...
cpow_test (void)
{
  ...
  check_complex ("cpow (2 + 0 i, 10 + 0 i) == 1024.0 + 0.0 i",  FUNC(cpow) (BUILD_COMPLEX (2, 0), BUILD_COMPLEX (10, 0)), BUILD_COMPLEX (1024.0, 0.0), DELTA657, 0, 0);
...
csin_test (void)
{
  ...
  check_complex ("csin (-2 - 3 i) == -9.15449914691142957346729954460983256 + 4.16890695996656435075481305885375484 i",  FUNC(csin) (BUILD_COMPLEX (-2, -3)), BUILD_COMPLEX (-9.15449914691142957346729954460983256L, 4.16890695996656435075481305885375484L), DELTA721, 0, 0);
...
csqrt_test (void)
{
  ...
  check_complex ("csqrt (0.75 + 1.25 i) == 1.05065169626078392338656675760808326 + 0.594868882070379067881984030639932657 i",  FUNC(csqrt) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (1.05065169626078392338656675760808326L, 0.594868882070379067881984030639932657L), DELTA800, 0, 0);
  check_complex ("csqrt (-2 - 3 i) == 0.89597747612983812471573375529004348 - 1.6741492280355400404480393008490519 i",  FUNC(csqrt) (BUILD_COMPLEX (-2, -3)), BUILD_COMPLEX (0.89597747612983812471573375529004348L, -1.6741492280355400404480393008490519L), DELTA801, 0, 0);
  check_complex ("csqrt (-2 + 3 i) == 0.89597747612983812471573375529004348 + 1.6741492280355400404480393008490519 i",  FUNC(csqrt) (BUILD_COMPLEX (-2, 3)), BUILD_COMPLEX (0.89597747612983812471573375529004348L, 1.6741492280355400404480393008490519L), DELTA802, 0, 0);
...
# if LDBL_MIN_10_EXP < -319
  check_float ("erfc (27.0) == 0.523704892378925568501606768284954709e-318",  FUNC(erfc) (27.0L), 0.523704892378925568501606768284954709e-318L, DELTA892, 0, 0);
# endif
#endif
...
exp10_test (void)
{
  ...
  check_float ("exp10 (3) == 1000",  FUNC(exp10) (3), 1000, DELTA910, 0, 0);
  check_float ("exp10 (-1) == 0.1",  FUNC(exp10) (-1), 0.1L, DELTA911, 0, 0);
  check_float ("exp10 (1e6) == inf",  FUNC(exp10) (1e6), plus_infty, 0, 0, 0);
  check_float ("exp10 (-1e6) == 0",  FUNC(exp10) (-1e6), 0, 0, 0, 0);
  check_float ("exp10 (0.75) == 5.62341325190349080394951039776481231",  FUNC(exp10) (0.75L), 5.62341325190349080394951039776481231L, DELTA914, 0, 0);
...
exp2_test (void)
{
  ...
  check_float ("exp2 (10) == 1024",  FUNC(exp2) (10), 1024, DELTA920, 0, 0);
...
expm1_test (void)
{
  ...
  check_float ("expm1 (1) == M_El - 1.0",  FUNC(expm1) (1), M_El - 1.0, DELTA930, 0, 0);
  check_float ("expm1 (0.75) == 1.11700001661267466854536981983709561",  FUNC(expm1) (0.75L), 1.11700001661267466854536981983709561L, DELTA931, 0, 0);
...
gamma_test (void)
{
  ...
  signgam = 0;
  check_float ("gamma (-0.5) == log(2*sqrt(pi))",  FUNC(gamma) (-0.5), M_LOG_2_SQRT_PIl, DELTA1196, 0, 0);
  check_int ("gamma (-0.5) sets signgam to -1", signgam, -1, 0, 0, 0);
...
hypot_test (void)
{
  ...
  /* hypot (x,y) == hypot (+-x, +-y)  */
  check_float ("hypot (0.7, 12.4) == 12.419742348374220601176836866763271",  FUNC(hypot) (0.7L, 12.4L), 12.419742348374220601176836866763271L, DELTA1205, 0, 0);
  ...
  check_float ("hypot (12.4, 0.7) == 12.419742348374220601176836866763271",  FUNC(hypot) (12.4L, 0.7L), 12.419742348374220601176836866763271L, DELTA1209, 0, 0);
...
j0_test (void)
{
  ...
  check_float ("j0 (0.75) == 0.864242275166648623555731103820923211",  FUNC(j0) (0.75L), 0.864242275166648623555731103820923211L, DELTA1242, 0, 0);
  check_float ("j0 (1.0) == 0.765197686557966551449717526102663221",  FUNC(j0) (1.0), 0.765197686557966551449717526102663221L, 0, 0, 0);
  check_float ("j0 (1.5) == 0.511827671735918128749051744283411720",  FUNC(j0) (1.5), 0.511827671735918128749051744283411720L, 0, 0, 0);
  check_float ("j0 (2.0) == 0.223890779141235668051827454649948626",  FUNC(j0) (2.0), 0.223890779141235668051827454649948626L, DELTA1245, 0, 0);
  check_float ("j0 (8.0) == 0.171650807137553906090869407851972001",  FUNC(j0) (8.0), 0.171650807137553906090869407851972001L, DELTA1246, 0, 0);
  check_float ("j0 (10.0) == -0.245935764451348335197760862485328754",  FUNC(j0) (10.0), -0.245935764451348335197760862485328754L, DELTA1247, 0, 0);
  check_float ("j0 (4.0) == -3.9714980986384737228659076845169804197562E-1",  FUNC(j0) (4.0), -3.9714980986384737228659076845169804197562E-1L, DELTA1248, 0, 0);
...
j1_test (void)
{
  ...
  check_float ("j1 (-1.0) == -0.440050585744933515959682203718914913",  FUNC(j1) (-1.0), -0.440050585744933515959682203718914913L, DELTA1252, 0, 0);
  ...
  check_float ("j1 (0.75) == 0.349243602174862192523281016426251335",  FUNC(j1) (0.75L), 0.349243602174862192523281016426251335L, DELTA1255, 0, 0);
  check_float ("j1 (1.0) == 0.440050585744933515959682203718914913",  FUNC(j1) (1.0), 0.440050585744933515959682203718914913L, DELTA1256, 0, 0);
  check_float ("j1 (1.5) == 0.557936507910099641990121213156089400",  FUNC(j1) (1.5), 0.557936507910099641990121213156089400L, 0, 0, 0);
  check_float ("j1 (2.0) == 0.576724807756873387202448242269137087",  FUNC(j1) (2.0), 0.576724807756873387202448242269137087L, DELTA1258, 0, 0);
  check_float ("j1 (8.0) == 0.234636346853914624381276651590454612",  FUNC(j1) (8.0), 0.234636346853914624381276651590454612L, DELTA1259, 0, 0);
  check_float ("j1 (10.0) == 0.0434727461688614366697487680258592883",  FUNC(j1) (10.0), 0.0434727461688614366697487680258592883L, DELTA1260, 0, 0);
...
jn_test (void)
{
  ...
  check_float ("jn (0, 0.75) == 0.864242275166648623555731103820923211",  FUNC(jn) (0, 0.75L), 0.864242275166648623555731103820923211L, DELTA1266, 0, 0);
  check_float ("jn (0, 1.0) == 0.765197686557966551449717526102663221",  FUNC(jn) (0, 1.0), 0.765197686557966551449717526102663221L, 0, 0, 0);
  check_float ("jn (0, 1.5) == 0.511827671735918128749051744283411720",  FUNC(jn) (0, 1.5), 0.511827671735918128749051744283411720L, 0, 0, 0);
  check_float ("jn (0, 2.0) == 0.223890779141235668051827454649948626",  FUNC(jn) (0, 2.0), 0.223890779141235668051827454649948626L, DELTA1269, 0, 0);
  check_float ("jn (0, 8.0) == 0.171650807137553906090869407851972001",  FUNC(jn) (0, 8.0), 0.171650807137553906090869407851972001L, DELTA1270, 0, 0);
  check_float ("jn (0, 10.0) == -0.245935764451348335197760862485328754",  FUNC(jn) (0, 10.0), -0.245935764451348335197760862485328754L, DELTA1271, 0, 0);
  check_float ("jn (0, 4.0) == -3.9714980986384737228659076845169804197562E-1",  FUNC(jn) (0, 4.0), -3.9714980986384737228659076845169804197562E-1L, DELTA1272, 0, 0);
  ...
  check_float ("jn (1, -1.0) == -0.440050585744933515959682203718914913",  FUNC(jn) (1, -1.0), -0.440050585744933515959682203718914913L, DELTA1276, 0, 0);
  ...
  check_float ("jn (1, 0.75) == 0.349243602174862192523281016426251335",  FUNC(jn) (1, 0.75L), 0.349243602174862192523281016426251335L, DELTA1279, 0, 0);
  check_float ("jn (1, 1.0) == 0.440050585744933515959682203718914913",  FUNC(jn) (1, 1.0), 0.440050585744933515959682203718914913L, DELTA1280, 0, 0);
  check_float ("jn (1, 1.5) == 0.557936507910099641990121213156089400",  FUNC(jn) (1, 1.5), 0.557936507910099641990121213156089400L, 0, 0, 0);
  check_float ("jn (1, 2.0) == 0.576724807756873387202448242269137087",  FUNC(jn) (1, 2.0), 0.576724807756873387202448242269137087L, DELTA1282, 0, 0);
  check_float ("jn (1, 8.0) == 0.234636346853914624381276651590454612",  FUNC(jn) (1, 8.0), 0.234636346853914624381276651590454612L, DELTA1283, 0, 0);
  check_float ("jn (1, 10.0) == 0.0434727461688614366697487680258592883",  FUNC(jn) (1, 10.0), 0.0434727461688614366697487680258592883L, DELTA1284, 0, 0);
  ...
  check_float ("jn (3, 0.125) == 0.406503832554912875023029337653442868e-4",  FUNC(jn) (3, 0.125L), 0.406503832554912875023029337653442868e-4L, DELTA1289, 0, 0);
  check_float ("jn (3, 0.75) == 0.848438342327410884392755236884386804e-2",  FUNC(jn) (3, 0.75L), 0.848438342327410884392755236884386804e-2L, DELTA1290, 0, 0);
  check_float ("jn (3, 1.0) == 0.0195633539826684059189053216217515083",  FUNC(jn) (3, 1.0), 0.0195633539826684059189053216217515083L, 0, 0, 0);
  check_float ("jn (3, 2.0) == 0.128943249474402051098793332969239835",  FUNC(jn) (3, 2.0), 0.128943249474402051098793332969239835L, DELTA1292, 0, 0);
  check_float ("jn (3, 10.0) == 0.0583793793051868123429354784103409563",  FUNC(jn) (3, 10.0), 0.0583793793051868123429354784103409563L, DELTA1293, 0, 0);

  /*  jn (10, x)  */
  check_float ("jn (10, NaN) == NaN",  FUNC(jn) (10, nan_value), nan_value, 0, 0, 0);
  check_float ("jn (10, inf) == 0",  FUNC(jn) (10, plus_infty), 0, 0, 0, 0);

  check_float ("jn (10, -1.0) == 0.263061512368745320699785368779050294e-9",  FUNC(jn) (10, -1.0), 0.263061512368745320699785368779050294e-9L, DELTA1296, 0, 0);
  check_float ("jn (10, 0.0) == 0.0",  FUNC(jn) (10, 0.0), 0.0, 0, 0, 0);
  check_float ("jn (10, 0.125) == 0.250543369809369890173993791865771547e-18",  FUNC(jn) (10, 0.125L), 0.250543369809369890173993791865771547e-18L, DELTA1298, 0, 0);
  check_float ("jn (10, 0.75) == 0.149621713117596814698712483621682835e-10",  FUNC(jn) (10, 0.75L), 0.149621713117596814698712483621682835e-10L, DELTA1299, 0, 0);
  check_float ("jn (10, 1.0) == 0.263061512368745320699785368779050294e-9",  FUNC(jn) (10, 1.0), 0.263061512368745320699785368779050294e-9L, DELTA1300, 0, 0);
  check_float ("jn (10, 2.0) == 0.251538628271673670963516093751820639e-6",  FUNC(jn) (10, 2.0), 0.251538628271673670963516093751820639e-6L, DELTA1301, 0, 0);
  check_float ("jn (10, 10.0) == 0.207486106633358857697278723518753428",  FUNC(jn) (10, 10.0), 0.207486106633358857697278723518753428L, DELTA1302, 0, 0);
...
lgamma_test (void)
{
  ...
  signgam = 0;
  check_float ("lgamma (-0.5) == log(2*sqrt(pi))",  FUNC(lgamma) (-0.5), M_LOG_2_SQRT_PIl, DELTA1323, 0, 0);
  check_int ("lgamma (-0.5) sets signgam to -1", signgam, -1, 0, 0, 0);
  signgam = 0;
  check_float ("lgamma (0.7) == 0.260867246531666514385732417016759578",  FUNC(lgamma) (0.7L), 0.260867246531666514385732417016759578L, DELTA1325, 0, 0);
  check_int ("lgamma (0.7) sets signgam to 1", signgam, 1, 0, 0, 0);
  signgam = 0;
  check_float ("lgamma (1.2) == -0.853740900033158497197028392998854470e-1",  FUNC(lgamma) (1.2L), -0.853740900033158497197028392998854470e-1L, DELTA1327, 0, 0);
...
log10_test (void)
{
  ...
  check_float ("log10 (e) == log10(e)",  FUNC(log10) (M_El), M_LOG10El, DELTA1853, 0, 0);
  check_float ("log10 (0.75) == -0.124938736608299953132449886193870744",  FUNC(log10) (0.75L), -0.124938736608299953132449886193870744L, DELTA1854, 0, 0);
...
log1p_test (void)
{
  ...
  check_float ("log1p (M_El - 1.0) == 1",  FUNC(log1p) (M_El - 1.0), 1, DELTA1862, 0, 0);

  check_float ("log1p (-0.25) == -0.287682072451780927439219005993827432",  FUNC(log1p) (-0.25L), -0.287682072451780927439219005993827432L, DELTA1863, 0, 0);
...
log2_test (void)
{
  ...
  check_float ("log2 (0.75) == -.415037499278843818546261056052183492",  FUNC(log2) (0.75L), -.415037499278843818546261056052183492L, DELTA1876, 0, 0);
...
sincos_test (void)
{
  ...
  check_float ("sincos (pi/2, &sin_res, &cos_res) puts 0 in cos_res", cos_res, 0, DELTA2642, 0, 0);
  FUNC (sincos) (M_PI_6l, &sin_res, &cos_res);
  check_float ("sincos (pi/6, &sin_res, &cos_res) puts 0.5 in sin_res", sin_res, 0.5, 0, 0, 0);
  check_float ("sincos (pi/6, &sin_res, &cos_res) puts 0.86602540378443864676372317075293616 in cos_res", cos_res, 0.86602540378443864676372317075293616L, DELTA2644, 0, 0);
  FUNC (sincos) (M_PI_6l*2.0, &sin_res, &cos_res);
  check_float ("sincos (M_PI_6l*2.0, &sin_res, &cos_res) puts 0.86602540378443864676372317075293616 in sin_res", sin_res, 0.86602540378443864676372317075293616L, DELTA2645, 0, 0);
  check_float ("sincos (M_PI_6l*2.0, &sin_res, &cos_res) puts 0.5 in cos_res", cos_res, 0.5, DELTA2646, 0, 0);
...
sqrt_test (void)
{
  ...
  check_float ("sqrt (2) == M_SQRT2l",  FUNC(sqrt) (2), M_SQRT2l, DELTA2667, 0, 0);
...
tan_test (void)
{
  ...
  check_float ("tan (pi/4) == 1",  FUNC(tan) (M_PI_4l), 1, DELTA2677, 0, 0);
...
tanh_test (void)
{
  ...
  check_float ("tanh (0.75) == 0.635148952387287319214434357312496495",  FUNC(tanh) (0.75L), 0.635148952387287319214434357312496495L, DELTA2684, 0, 0);
  check_float ("tanh (-0.75) == -0.635148952387287319214434357312496495",  FUNC(tanh) (-0.75L), -0.635148952387287319214434357312496495L, DELTA2685, 0, 0);

  check_float ("tanh (1.0) == 0.7615941559557648881194582826047935904",  FUNC(tanh) (1.0L), 0.7615941559557648881194582826047935904L, DELTA2686, 0, 0);
  check_float ("tanh (-1.0) == -0.7615941559557648881194582826047935904",  FUNC(tanh) (-1.0L), -0.7615941559557648881194582826047935904L, DELTA2687, 0, 0);
...
tgamma_test (void)
{
  ...
  check_float ("tgamma (0.5) == sqrt (pi)",  FUNC(tgamma) (0.5), M_SQRT_PIl, DELTA2695, 0, 0);
  check_float ("tgamma (-0.5) == -2 sqrt (pi)",  FUNC(tgamma) (-0.5), -M_2_SQRT_PIl, DELTA2696, 0, 0);

  check_float ("tgamma (1) == 1",  FUNC(tgamma) (1), 1, 0, 0, 0);
  check_float ("tgamma (4) == 6",  FUNC(tgamma) (4), 6, DELTA2698, 0, 0);

  check_float ("tgamma (0.7) == 1.29805533264755778568117117915281162",  FUNC(tgamma) (0.7L), 1.29805533264755778568117117915281162L, DELTA2699, 0, 0);
...
y0_test (void)
{
  ...
  check_float ("y0 (1.0) == 0.0882569642156769579829267660235151628",  FUNC(y0) (1.0), 0.0882569642156769579829267660235151628L, DELTA2781, 0, 0);
  check_float ("y0 (1.5) == 0.382448923797758843955068554978089862",  FUNC(y0) (1.5), 0.382448923797758843955068554978089862L, DELTA2782, 0, 0);
  check_float ("y0 (2.0) == 0.510375672649745119596606592727157873",  FUNC(y0) (2.0), 0.510375672649745119596606592727157873L, 0, 0, 0);
  check_float ("y0 (8.0) == 0.223521489387566220527323400498620359",  FUNC(y0) (8.0), 0.223521489387566220527323400498620359L, DELTA2784, 0, 0);
  check_float ("y0 (10.0) == 0.0556711672835993914244598774101900481",  FUNC(y0) (10.0), 0.0556711672835993914244598774101900481L, DELTA2785, 0, 0);
...
y1_test (void)
{
  ...
  check_float ("y1 (0.125) == -5.19993611253477499595928744876579921",  FUNC(y1) (0.125L), -5.19993611253477499595928744876579921L, DELTA2790, 0, 0);
  check_float ("y1 (0.75) == -1.03759455076928541973767132140642198",  FUNC(y1) (0.75L), -1.03759455076928541973767132140642198L, DELTA2791, 0, 0);
  check_float ("y1 (1.0) == -0.781212821300288716547150000047964821",  FUNC(y1) (1.0), -0.781212821300288716547150000047964821L, 0, 0, 0);
  check_float ("y1 (1.5) == -0.412308626973911295952829820633445323",  FUNC(y1) (1.5), -0.412308626973911295952829820633445323L, DELTA2793, 0, 0);
  check_float ("y1 (2.0) == -0.107032431540937546888370772277476637",  FUNC(y1) (2.0), -0.107032431540937546888370772277476637L, DELTA2794, 0, 0);
  check_float ("y1 (8.0) == -0.158060461731247494255555266187483550",  FUNC(y1) (8.0), -0.158060461731247494255555266187483550L, DELTA2795, 0, 0);
  check_float ("y1 (10.0) == 0.249015424206953883923283474663222803",  FUNC(y1) (10.0), 0.249015424206953883923283474663222803L, DELTA2796, 0, 0);
...
yn_test (void)
{
  ...
  check_float ("yn (0, 1.0) == 0.0882569642156769579829267660235151628",  FUNC(yn) (0, 1.0), 0.0882569642156769579829267660235151628L, DELTA2803, 0, 0);
  check_float ("yn (0, 1.5) == 0.382448923797758843955068554978089862",  FUNC(yn) (0, 1.5), 0.382448923797758843955068554978089862L, DELTA2804, 0, 0);
  check_float ("yn (0, 2.0) == 0.510375672649745119596606592727157873",  FUNC(yn) (0, 2.0), 0.510375672649745119596606592727157873L, 0, 0, 0);
  check_float ("yn (0, 8.0) == 0.223521489387566220527323400498620359",  FUNC(yn) (0, 8.0), 0.223521489387566220527323400498620359L, DELTA2806, 0, 0);
  check_float ("yn (0, 10.0) == 0.0556711672835993914244598774101900481",  FUNC(yn) (0, 10.0), 0.0556711672835993914244598774101900481L, DELTA2807, 0, 0);
  ...
  check_float ("yn (1, 0.125) == -5.19993611253477499595928744876579921",  FUNC(yn) (1, 0.125L), -5.19993611253477499595928744876579921L, DELTA2812, 0, 0);
  check_float ("yn (1, 0.75) == -1.03759455076928541973767132140642198",  FUNC(yn) (1, 0.75L), -1.03759455076928541973767132140642198L, DELTA2813, 0, 0);
  check_float ("yn (1, 1.0) == -0.781212821300288716547150000047964821",  FUNC(yn) (1, 1.0), -0.781212821300288716547150000047964821L, 0, 0, 0);
  check_float ("yn (1, 1.5) == -0.412308626973911295952829820633445323",  FUNC(yn) (1, 1.5), -0.412308626973911295952829820633445323L, DELTA2815, 0, 0);
  check_float ("yn (1, 2.0) == -0.107032431540937546888370772277476637",  FUNC(yn) (1, 2.0), -0.107032431540937546888370772277476637L, DELTA2816, 0, 0);
  check_float ("yn (1, 8.0) == -0.158060461731247494255555266187483550",  FUNC(yn) (1, 8.0), -0.158060461731247494255555266187483550L, DELTA2817, 0, 0);
  check_float ("yn (1, 10.0) == 0.249015424206953883923283474663222803",  FUNC(yn) (1, 10.0), 0.249015424206953883923283474663222803L, DELTA2818, 0, 0);

  /* yn (3, x)  */
  check_float ("yn (3, inf) == 0",  FUNC(yn) (3, plus_infty), 0, 0, 0, 0);
  check_float ("yn (3, NaN) == NaN",  FUNC(yn) (3, nan_value), nan_value, 0, 0, 0);

  check_float ("yn (3, 0.125) == -2612.69757350066712600220955744091741",  FUNC(yn) (3, 0.125L), -2612.69757350066712600220955744091741L, DELTA2821, 0, 0);
  check_float ("yn (3, 0.75) == -12.9877176234475433186319774484809207",  FUNC(yn) (3, 0.75L), -12.9877176234475433186319774484809207L, DELTA2822, 0, 0);
  check_float ("yn (3, 1.0) == -5.82151760596472884776175706442981440",  FUNC(yn) (3, 1.0), -5.82151760596472884776175706442981440L, 0, 0, 0);
  check_float ("yn (3, 2.0) == -1.12778377684042778608158395773179238",  FUNC(yn) (3, 2.0), -1.12778377684042778608158395773179238L, DELTA2824, 0, 0);
  check_float ("yn (3, 10.0) == -0.251362657183837329779204747654240998",  FUNC(yn) (3, 10.0), -0.251362657183837329779204747654240998L, DELTA2825, 0, 0);

  /* yn (10, x)  */
  check_float ("yn (10, inf) == 0",  FUNC(yn) (10, plus_infty), 0, 0, 0, 0);
  check_float ("yn (10, NaN) == NaN",  FUNC(yn) (10, nan_value), nan_value, 0, 0, 0);

  check_float ("yn (10, 0.125) == -127057845771019398.252538486899753195",  FUNC(yn) (10, 0.125L), -127057845771019398.252538486899753195L, DELTA2828, 0, 0);
  check_float ("yn (10, 0.75) == -2133501638.90573424452445412893839236",  FUNC(yn) (10, 0.75L), -2133501638.90573424452445412893839236L, DELTA2829, 0, 0);
  check_float ("yn (10, 1.0) == -121618014.278689189288130426667971145",  FUNC(yn) (10, 1.0), -121618014.278689189288130426667971145L, DELTA2830, 0, 0);
  check_float ("yn (10, 2.0) == -129184.542208039282635913145923304214",  FUNC(yn) (10, 2.0), -129184.542208039282635913145923304214L, DELTA2831, 0, 0);
  check_float ("yn (10, 10.0) == -0.359814152183402722051986577343560609",  FUNC(yn) (10, 10.0), -0.359814152183402722051986577343560609L, DELTA2832, 0, 0);
